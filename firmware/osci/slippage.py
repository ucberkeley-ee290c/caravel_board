...
# IO Configuration Constant Definitions
# Adapted from `defs_mpw-two-mfix.h`:
...
# FIXME: `defs.h` includes this *one* difference:
#define GPIO_MODE_USER_STD_BIDIRECTIONAL   0x1800
# It's not clear which is correct.

gpio_0 = GPIO_MODE_USER_STD_OUTPUT          # .serial_tl_clock(io_out[0]),
gpio_1 = GPIO_MODE_USER_STD_OUTPUT          # .serial_tl_bits_in_ready(io_out[1]),
gpio_2 = GPIO_MODE_USER_STD_INPUT_NOPULL    # .serial_tl_bits_in_valid(io_in[2]),
gpio_3 = GPIO_MODE_USER_STD_INPUT_NOPULL    # .serial_tl_bits_in_bits(io_in[3]),
gpio_4 = GPIO_MODE_USER_STD_INPUT_NOPULL    # .serial_tl_bits_out_ready(io_in[4]),
gpio_5 = GPIO_MODE_USER_STD_OUTPUT          # .serial_tl_bits_out_valid(io_out[5]),
gpio_6 = GPIO_MODE_USER_STD_OUTPUT          # .serial_tl_bits_out_bits(io_out[6]),
gpio_7 = GPIO_MODE_USER_STD_BIDIRECTIONAL   # .gpio_0_0_i(io_in[7]), 
gpio_8 = GPIO_MODE_USER_STD_BIDIRECTIONAL   # .gpio_0_1_i(io_in[8]),
gpio_9 = GPIO_MODE_USER_STD_BIDIRECTIONAL   # .gpio_0_2_i(io_in[9]),
gpio_10 = GPIO_MODE_USER_STD_INPUT_NOPULL   # .reset(io_in[10]),
gpio_11 = GPIO_MODE_USER_STD_INPUT_NOPULL   # .clock(io_in[11]),
gpio_12 = GPIO_MODE_USER_STD_INPUT_PULLDOWN   # Unused
gpio_13 = GPIO_MODE_USER_STD_INPUT_PULLDOWN   # Unused
gpio_14 = GPIO_MODE_USER_STD_OUTPUT         # .spi_0_sck(io_out[14]),
gpio_15 = GPIO_MODE_USER_STD_OUTPUT         # .spi_0_cs_0(io_out[15]),
gpio_16 = GPIO_MODE_USER_STD_BIDIRECTIONAL  # .spi_0_dq_0_i(io_in[16]), 
gpio_17 = GPIO_MODE_USER_STD_BIDIRECTIONAL  # .spi_0_dq_1_i(io_in[17]),
gpio_18 = GPIO_MODE_USER_STD_BIDIRECTIONAL  # .spi_0_dq_2_i(io_in[18]),
...
# gpio_8  = 0x1808	# management output
# gpio_9  = 0x0403	# user input
# gpio_10 = 0x1808	# management output
# gpio_11 = 0x0403	# user input
# gpio_12 = 0x1808	# management output
# gpio_13 = 0x0403	# user input
# gpio_14 = 0x1808	# management output
# gpio_15 = 0x0403	# user input
# gpio_16 = 0x1808	# management output
# gpio_17 = 0x0403	# user input
# gpio_18 = 0x1808	# management output
